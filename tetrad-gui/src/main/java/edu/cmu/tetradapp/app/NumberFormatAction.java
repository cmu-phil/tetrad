...
final class NumberFormatAction extends AbstractAction
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        JTextField renderFieldBasic = new JTextField(
                new DecimalFormat(this.constructSimpleFormatString()).format(sample));
        ...
        scientific.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                Preferences.userRoot().putBoolean("scientificNotation",
                        checkBox.isSelected());
                renderFieldBasic.setText(new DecimalFormat(NumberFormatAction.this.constructSimpleFormatString()).format(sample));
                formatField.setText(NumberFormatAction.this.constructSimpleFormatString());
            }
        });
        ...
        if (!Preferences.userRoot().getBoolean("numFormatAdvanced", false)) {
            formatField.setText(this.constructSimpleFormatString());
        }
        ...
        JTextField renderFieldAdvanced = new JTextField(this.getNumberFormat().format(sample));
