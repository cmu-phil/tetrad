...
public final class SessionEditorNode extends DisplayNode {
    ...
    private void launchEditorVisit() {
        try {
            ...
            final Object[] arguments = new Object[]{model};
...
//                }
            ...
            final Component centeringComp = SessionEditorNode.this;
...
//    }
    ...
    private static void loadModelClassesFromConfig(final SessionNode sessionNode) {
        ...
        if (nodeName != null) {
            final String baseName = extractBase(nodeName);
            final Class[] newModelClasses = modelClasses(baseName);
    ...
    public SessionNode getSessionNode() {
        final SessionNodeWrapper wrapper = (SessionNodeWrapper) super.getModelNode();
