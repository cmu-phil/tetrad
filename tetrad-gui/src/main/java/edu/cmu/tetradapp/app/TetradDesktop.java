...
public final class TetradDesktop extends JPanel implements DesktopControllable,
     ...
     *
     * @param desktopPane
     *            the desktop pane that the frame is being added to.
     * @param frame
     *            the JInternalFrame which is being added.
     * @param desiredSize
     *            the desired dimensions of the frame.
     */
    private static void setGoodBounds(JInternalFrame frame,
    ...
    /**
     * A listener that prevents the display from moving too high in the desktop.
     */
