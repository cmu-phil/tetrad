...
/**
 * This is the toolbar for the DAG graph editor. Its tools are as follows:
 * <ul>
 ...
 * @see GraphEditor
 */
class DagGraphToolbar extends JPanel implements PropertyChangeListener {
    ...
    /**
     * Constructs a new DAG graph toolbar governing the modes of the given GraphWorkbench.
     *
     ...
     * Re-enables the directed edge button whenever the graph changes.
     */
    @Override
    ...
    /**
     * Sets the workbench interaction mode.
     */
