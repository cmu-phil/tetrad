        ...
        this.tableModel = new AbstractTableModel() {
            ...
            public Object getValueAt(final int rowIndex, final int columnIndex) {
                ...
                if (columnIndex == 1) {
                    ...
                    if (IndependenceFactsAction.this.independenceTest instanceof IndTestDSep) {
                        if (result.getType() == IndependenceFactsAction.Result.Type.INDEPENDENT) {
                            return "D-Separated";
                        } else if (result.getType() == IndependenceFactsAction.Result.Type.DEPENDENT) {
                            return "D-Connected";
                        } else if (result.getType() == IndependenceFactsAction.Result.Type.UNDETERMINED) {
                            return "*";
                        }
            ...
            public int compare(final Result r1, final Result r2) {
                ...
                switch (sortCol) {
                    ...
                    case 2:
                        ...
                        if (r1.getType() == IndependenceFactsAction.Result.Type.UNDETERMINED) {
                            ind1 = 0;
                        } else if (r1.getType() == IndependenceFactsAction.Result.Type.DEPENDENT) {
                            ind1 = 1;
                        } else {
                            ind1 = 2;
                        }

                        if (r2.getType() == IndependenceFactsAction.Result.Type.UNDETERMINED) {
                            ind2 = 0;
                        } else if (r2.getType() == IndependenceFactsAction.Result.Type.DEPENDENT) {
                            ind2 = 1;
                        } else {
                            ind2 = 2;
                        }
...
//                }
                ...
                for (int n = minPlus; n <= maxPlus; n++) {
                    ...
                    while ((choice2 = gen2.next()) != null) {
                        ...
                        IndependenceFactsAction.Result.Type indep;
                        double pValue;

                        try {
                            indep = getIndependenceTest().isIndependent(x, y, z) ? IndependenceFactsAction.Result.Type.INDEPENDENT : IndependenceFactsAction.Result.Type.DEPENDENT;
                        } catch (final Exception e) {
                            indep = IndependenceFactsAction.Result.Type.UNDETERMINED;
                        }
    ...
    public static final class Result {
        ...
        private final IndependenceFactsAction.Result.Type indep;
        private final double pValue;

        public Result(final int index, final String fact, final IndependenceFactsAction.Result.Type indep, final double pValue) {
            this.index = index;
            this.fact = fact;
            this.indep = indep;
            this.pValue = pValue;
        ...
        public IndependenceFactsAction.Result.Type getType() {
            return this.indep;
        }
