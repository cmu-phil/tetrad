...
class FofcIndTestParamsEditor extends JComponent {
    ...
    public FofcIndTestParamsEditor(Parameters params) {
        ...
        JComboBox<FindOneFactorClusters.Algorithm> algorithmSelector = new JComboBox<>();
        ...
        FindOneFactorClusters.Algorithm algorithmType = (FindOneFactorClusters.Algorithm) this.getParams().get("fofcAlgorithm",
