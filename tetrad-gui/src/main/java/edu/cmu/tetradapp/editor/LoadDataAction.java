...
//        }
        ...
        int _ret = chooser.showDialog(dataEditor, "Choose");
        ...
        if (!this.isDataEmpty()) {
            ...
            int option = JOptionPane.showOptionDialog(dataEditor, message, "Data Replacement",
...
//                    "No files were loaded.");
    ...
    private boolean isDataEmpty() {
        DataWrapper wrapper = dataEditor.getDataWrapper();
