 ...
 * probabilities ranging from 0.0 to 1.0. For a given combination of parent values for selectedNode N, the probabilities
 * for the values of N conditional on that combination of parent values must sum to 1.0
 *
 * @author josephramsey
 */
