...
final class ClusterRenderer extends JPanel {
    ...
    public ClusterRenderer(Clusters clusters, List<String> varNames) {
        ...
        numClusters = clusters.getNumClusters();
    ...
    private Box clusterDisplay() {
        ...
        clustersPanel.add(this.getClusterBoxes(this.getNumClusters()),
                BorderLayout.CENTER);
    ...
    private Box getClusterBoxes(int numClusters) {
        ...
        for (int cluster = 0; cluster < numClusters; cluster++) {
            ...
            List clusterNames = this.getClusters().getCluster(cluster);
        ...
        List varsNotInCluster =
                this.getClusters().getVarsNotInCluster(this.getVarNames());
        JList l1 =
