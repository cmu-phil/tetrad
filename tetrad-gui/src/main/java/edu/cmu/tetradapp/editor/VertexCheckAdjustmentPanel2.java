 ...
 */
public final class VertexCheckAdjustmentPanel2 extends JPanel {
    ...
    public VertexCheckAdjustmentPanel2(VertexCheckEditor editor, Node x) {
...
//            runRepairPhase(gt, RepairPhase.ALL, seenSweepStates, cycleWarnings);
        ...
        if (!cycleWarnings.isEmpty()) {
            ...
            SwingUtilities.invokeLater(() ->
                    JOptionPane.showMessageDialog(
                            VertexCheckAdjustmentPanel2.this,
                            message,
