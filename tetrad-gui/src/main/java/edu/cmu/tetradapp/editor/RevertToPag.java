 ...
 * @version $Id: $Id
 */
public class RevertToPag extends AbstractAction implements ClipboardOwner {
     ...
     */
    public RevertToPag(GraphWorkbench workbench) {
        super("Revert to PAG");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        workbench.setGraph(PagCache.getInstance().getPag(graph, false));
    }
