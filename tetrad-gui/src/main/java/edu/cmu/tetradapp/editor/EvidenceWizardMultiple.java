 ...
 */
class EvidenceWizardMultiple extends JPanel {
        ...
        calcMarginalsAndJointButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                List<DisplayNode> selectedGraphNodes =
                        EvidenceWizardMultiple.this.getWorkbench().getSelectedNodes();

                EvidenceWizardMultiple.this.getUpdaterWrapper().getBayesUpdater().setEvidence(evidenceEditor.getEvidence());
                ...
                BayesIm manipulatedIm = EvidenceWizardMultiple.this.getUpdaterWrapper()
                ...
                if (selectedNodes.size() == 0) {
                    ...
                    EvidenceWizardMultiple.this.appendMarginals(selectedNodes, marginalsArea, manipulatedIm,
                            nf);
                    EvidenceWizardMultiple.this.appendJoint(selectedNodes, marginalsArea, manipulatedIm,
                            nf);
                }
