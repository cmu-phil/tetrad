...
public abstract class AbstractWorkbench extends JComponent implements WorkbenchModel, LayoutEditable {
	 ...
	 *
	 * @param graph
	 *            The graph that this workbench will display.
	 */
	 ...
	 * @param width
	 *            The stroke width. By detault this is 1.0f. 5.0f is pretty
	 *            thick.
	 */
	 ...
	 *
	 * @param edge
	 *            the edge from which a label is to be removed.
	 */
	 ...
	 *
	 * @param workbenchMode
	 *            One of SELECT_MOVE, ADD_NODE, ADD_EDGE.
	 */
	 ...
	 *
	 * @param maxX
	 *            the maximum x value (Must be greater than or equal to 100).
	 */
	 ...
	 *
	 * @param maxY
	 *            the maximum Y value (Must be greater than or equal to 100).
	 */
	 ...
	 *
	 * @param loc
	 *            the location of the center of the session node.
	 ...
	 *
	 * @param i
	 *            the index of the given edge
	 * @param n
	 *            the number of edges
	 * @param w
	 *            the total width to spread edges over
	 */
	 ...
	 *
	 * @param p
	 *            the point for which the nearest node is requested.
	 ...
	 *
	 * @param rubberband
	 *            The rubberband shape appearing in the GUI.
	 * @param edgesOnly
	 ...
	 *
	 * @param node
	 *            the initial anchored node.
	 * @param mouseLoc
	 *            the initial tracking mouse location.
	 */
	 ...
	 *
	 * @param p
	 *            the point where the rubberband begins.
	...
	private static final class GraphEdgeLabel extends JComponent implements PropertyChangeListener {
		 ...
		 *
		 * @param edge
		 *            the edge with which the label is associated.
		 * @param label
		 *            the JComponent which serves as the label.
		 */
	...
	private static final class GraphNodeLabel extends JComponent {
		 ...
		 *
		 * @param node
		 *            the node with which the label is associated.
		 * @param label
		 *            the JComponent which serves as the label.
		 */
