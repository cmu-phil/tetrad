...
public class TimeSeriesParams implements Params {
    ...
    private void readObject(ObjectInputStream s)
        ...
        if (this.numOfTimeLags < 1 || 20 < this.numOfTimeLags) {
            throw new IllegalStateException("Time of lags must be between 2 and 20: " + numOfTimeLags);
        }
    }
