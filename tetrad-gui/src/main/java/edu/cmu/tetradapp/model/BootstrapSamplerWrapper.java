...
public class BootstrapSamplerWrapper extends DataWrapper {
    ...
    public BootstrapSamplerWrapper(DataWrapper wrapper,
        ...
        DataSet dataSet = (DataSet) dataModel;
        BootstrapSampler sampler = new BootstrapSampler();
        outputDataSet = sampler.sample(dataSet, params.getInt("sampleSize", 1000));

        LogDataUtils.logDataModelList("Bootstrap sample of data in the parent node.", this.getDataModelList());
