...
public class TsFciRunner extends AbstractAlgorithmRunner
    ...
    public TsFciRunner(DataWrapper dataWrapper, GFciSearchParams params) {
     ...
     */
    public TsFciRunner(GraphSource graphWrapper, PcSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
     ...
     */
    public TsFciRunner(DataWrapper dataWrapper, GFciSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
    ...
    public TsFciRunner(GraphWrapper graphWrapper, GFciSearchParams params) {
        super(graphWrapper.getGraph(), params);
    }

    public TsFciRunner(DagWrapper dagWrapper, GFciSearchParams params) {
        super(dagWrapper.getDag(), params);
    }

    public TsFciRunner(SemGraphWrapper dagWrapper, GFciSearchParams params) {
        super(dagWrapper.getGraph(), params);
    }

    public TsFciRunner(IndependenceFactsModel model, GFciSearchParams params) {
        super(model, params, null);
    }

    public TsFciRunner(IndependenceFactsModel model, GFciSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
