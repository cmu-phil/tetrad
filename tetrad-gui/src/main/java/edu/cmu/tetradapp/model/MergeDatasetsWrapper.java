...
public class MergeDatasetsWrapper extends DataWrapper {
    ...
    public MergeDatasetsWrapper(DataWrapper data1, Parameters params) {
        construct(data1);
    }

    public MergeDatasetsWrapper(DataWrapper data1, DataWrapper data2, Parameters params) {
        construct(data1, data2);
    }

    public MergeDatasetsWrapper(DataWrapper data1, DataWrapper data2, DataWrapper data3, Parameters params) {
    ...
    public MergeDatasetsWrapper(DataWrapper data1, DataWrapper data2, DataWrapper data3,
                                DataWrapper data4, DataWrapper data5, DataWrapper data6,
                                DataWrapper data7, DataWrapper data8, DataWrapper data9, Parameters params) {
    ...
    public MergeDatasetsWrapper(DataWrapper data1, DataWrapper data2, DataWrapper data3,
                                ...
                                DataWrapper data10, Parameters params) {
