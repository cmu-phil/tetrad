 ...
 */
public class PcCPDAGRunner extends AbstractAlgorithmRunner
     ...
     */
    public static PcCPDAGRunner serializableInstance() {
        return new PcCPDAGRunner(Dag.serializableInstance(), new Parameters());
    }
    ...
    public void execute() {
        ...
        PcCPDAG pcSearch = new PcCPDAG(this.getIndependenceTest());
        pcSearch.setKnowledge(knowledge);
        pcSearch.setAggressivelyPreventCycles(this.isAggressivelyPreventCycles());
