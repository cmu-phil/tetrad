 ...
 */
public final class FciSearchParamsOld implements SearchParams {
     ...
     * @serial Cannot be null.
     */
    private FciIndTestParamsOld indTestParams2 = new FciIndTestParamsOld();
    ...
    public void setIndTestParams(IndTestParams indTestParams2) {
        ...
        this.indTestParams2 = (FciIndTestParamsOld) indTestParams2;
    }
    ...
    private void readObject(ObjectInputStream s)
        ...
        if (indTestParams2 == null) {
            indTestParams2 = new FciIndTestParamsOld();
//            throw new NullPointerException();
        }
