 ...
 */
public final class FtfcParams implements MimParams {
     ...
     * @serial Cannot be null.
     */
    private FtfcIndTestParams indTestParams;
     ...
     */
    public FtfcParams() {
        indTestParams = new FtfcIndTestParams();
    }
     ...
     */
    public static FtfcParams serializableInstance() {
        return new FtfcParams();
    }
