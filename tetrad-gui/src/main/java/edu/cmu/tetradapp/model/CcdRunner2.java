...
public class CcdRunner2 extends AbstractAlgorithmRunner
    ...
    public CcdRunner2(DataWrapper dataWrapper, KnowledgeBoxModel knowledgeBoxModel, BasicSearchParams params) {
        super(dataWrapper, params, knowledgeBoxModel);
    }

    public CcdRunner2(DataWrapper dataWrapper, GraphWrapper initialGraph, BasicSearchParams params) {
     ...
     */
    public CcdRunner2(GraphSource graphWrapper, PcSearchParams params) {
     ...
     * Constucts a wrapper for the given EdgeListGraph.
     */
    public CcdRunner2(GraphWrapper graphWrapper, KnowledgeBoxModel knowledgeBoxModel, BasicSearchParams params) {
    ...
    public static CcdRunner2 serializableInstance() {
        return new CcdRunner2(DataWrapper.serializableInstance(), BasicSearchParams.serializableInstance());
    }
