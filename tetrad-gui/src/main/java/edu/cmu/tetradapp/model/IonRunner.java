...
public class IonRunner extends AbstractAlgorithmRunner
    ...
    public void execute() {
        ...
        IonJoeModifications ion = new IonJoeModifications(this.getGraphs());
        ...
        ion.setKnowledge((IKnowledge) this.getParams().get("knowledge", new Knowledge2()));
        ...
        this.getParams().set("graphIndex", 0);
