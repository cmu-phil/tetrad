 ...
 */
public class CompletedCPDAGWrapper implements SessionModel, GraphSource {
    ...
    private CompletedCPDAGWrapper(Graph graph) {
        if (graph == null) {
     ...
     */
    public static CompletedCPDAGWrapper serializableInstance() {
        return new CompletedCPDAGWrapper(Dag.serializableInstance());
    }
