...
public class FgsRunnerCyclic extends AbstractAlgorithmRunner implements IFgsRunner, GraphSource,
    ...
    private int index;
    private transient FgsCyclic fgs;
    private transient Graph initialGraph;
    private FgsRunner.Type type;

    //============================CONSTRUCTORS============================//

    public FgsRunnerCyclic(DataWrapper dataWrapper, FgsParams params, KnowledgeBoxModel knowledgeBoxModel) {
        super(new MergeDatasetsWrapper(dataWrapper), params, knowledgeBoxModel);
        type = computeType();
    }

    public FgsRunnerCyclic(DataWrapper dataWrapper, FgsParams params) {
        super(new MergeDatasetsWrapper(dataWrapper), params, null);
        type = computeType();
    }

    public FgsRunnerCyclic(DataWrapper dataWrapper, GraphSource graph, FgsParams params) {
        super(new MergeDatasetsWrapper(dataWrapper), params, null);
//        if (graph == dataWrapper) throw new IllegalArgumentException();
    ...
    public FgsRunnerCyclic(DataWrapper dataWrapper, GraphSource graph, FgsParams params, KnowledgeBoxModel knowledgeBoxModel) {
        super(new MergeDatasetsWrapper(dataWrapper), params, knowledgeBoxModel);
        if (graph == this) throw new IllegalArgumentException();
        this.initialGraph = graph.getGraph();
        type = computeType();
    ...
    public FgsRunnerCyclic(DataWrapper dataWrapper1,
    ...
    public FgsRunnerCyclic(GraphWrapper graphWrapper, FgsParams params, KnowledgeBoxModel knowledgeBoxModel) {
        super(graphWrapper.getGraph(), params, knowledgeBoxModel);
        type = computeType();
    }

    public FgsRunnerCyclic(GraphWrapper graphWrapper, FgsParams params) {
     ...
     */
    public static FgsRunnerCyclic serializableInstance() {
        return new FgsRunnerCyclic(DataWrapper.serializableInstance(),
        ...
        if (model instanceof Graph) {
            ...
            if (allContinuous(list)) {
                ...
                if (indTestParams.isFirstNontriangular()) {
                    fgs = new FgsCyclic(new SemBicScoreImages(list));
                ...
                if (indTestParams.isFirstNontriangular()) {
                    fgs = new FgsCyclic(new BdeuScoreImages(list));
