...
public class TabularDataFileReaderTest {
    ...
    private final Path[] continuousDataFiles = {
            Paths.get(this.getClass().getResource("/data/tabular/continuous/dos_sim_test_data.csv").getFile()),
            Paths.get(this.getClass().getResource("/data/tabular/continuous/mac_sim_test_data.csv").getFile()),
            Paths.get(this.getClass().getResource("/data/tabular/continuous/sim_test_data.csv").getFile()),
            Paths.get(this.getClass().getResource("/data/tabular/continuous/quotes_sim_test_data.csv").getFile())
    };
    ...
    private final Path[] mixedDataFiles = {
            Paths.get(this.getClass().getResource("/data/tabular/mixed/dos_sim_test_data.csv").getFile()),
            Paths.get(this.getClass().getResource("/data/tabular/mixed/mac_sim_test_data.csv").getFile()),
            Paths.get(this.getClass().getResource("/data/tabular/mixed/sim_test_data.csv").getFile()),
            Paths.get(this.getClass().getResource("/data/tabular/mixed/quotes_sim_test_data.csv").getFile())
    };
    ...
    public void testReadInContinuousDataWitMetadata() throws IOException {
        Path dataFile = Paths.get(this.getClass().getResource("/data/metadata/sim_continuous_intervention.txt").getFile());
        Path metadataFile = Paths.get(this.getClass().getResource("/data/metadata/sim_continuous_intervention_metadata.json").getFile());
    ...
    public void testReadInDiscreteDataWitMetadata() throws IOException {
        Path dataFile = Paths.get(this.getClass().getResource("/data/metadata/sim_discrete_intervention.txt").getFile());
        Path metadataFile = Paths.get(this.getClass().getResource("/data/metadata/sim_discrete_intervention_metadata.json").getFile());
    ...
    public void testReadInSampleMixedDataWitMetadata() throws IOException {
        Path dataFile = Paths.get(this.getClass().getResource("/data/metadata/sample_dataset.txt").getFile());
        Path metadataFile = Paths.get(this.getClass().getResource("/data/metadata/sample_metadata.json").getFile());
