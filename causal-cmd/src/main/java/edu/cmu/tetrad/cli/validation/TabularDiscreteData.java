 ...
 */
public class TabularDiscreteData extends AbstractDataReader implements DataValidation {
    ...
    public TabularDiscreteData(Path dataFile, char delimiter) {
        this(Collections.EMPTY_SET, dataFile, delimiter);
    }
    ...
    private VariableAnalysis analyzeVariables(PrintStream stderr) throws IOException {
    ...
    private class VariableAnalysis {
