...
public class GesTrialRunner extends AbstractAlgorithmRunner implements GraphSource,
    ...
    public GesTrialRunner(DataWrapper dataWrapper, GesParams params) {
        super(dataWrapper, params, null);
    }

    public GesTrialRunner(DataWrapper dataWrapper, GraphSource trueGraph, GesParams params) {
        this(dataWrapper, params, null);
        this.initialGraph = trueGraph.getGraph();
    }

    public GesTrialRunner(DataWrapper dataWrapper, GesParams params, KnowledgeBoxModel knowledgeBoxModel) {
     ...
     */
    public GesTrialRunner(GraphSource graphWrapper, PcSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
    ...
    public static IGesRunner serializableInstance() {
        return new GesTrialRunner(DataWrapper.serializableInstance(),
...
//            ges = new FastGesTrial((ICovarianceMatrix) source);
...
//                ges.setFaithfulnessAssumed(faithfulnessAssumed);
                ...
                SemBicScore gesScore = new SemBicScore(new CovarianceMatrix(dataSet));
...
//                ges.setKnowledge(getParams().getKnowledge());
    ...
    private Map<Graph, Double> scoreGraphs(FastGesTrial ges, Graph graph) {
