 ...
 * @deprecated Need to keep this here for serialization purposes. Uses IcpcRunner instead.
 * @serial
 */
public class AcpcRunner extends AbstractAlgorithmRunner
     ...
     * containing either a DataSet or a DataSet as its selected model.
     */
    public AcpcRunner(DataWrapper dataWrapper, PcSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
