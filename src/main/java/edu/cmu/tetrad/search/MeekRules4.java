 ...
 */
public class MeekRules4 implements ImpliedOrientation {
...
//    private Set<Node> colliderNodes = null;
     ...
     */
    public MeekRules4(IndependenceTest test) {
...
//                            continue;
    ...
    private boolean isUnshieldedNoncollider(Node a, Node b, Node c,
        ...
        SearchGraphUtils.CpcTripleType type = SearchGraphUtils.getCpcTripleType(a, b, c, test, 2, graph, false);

        return type == SearchGraphUtils.CpcTripleType.NONCOLLIDER;
