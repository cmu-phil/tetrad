 ...
 */
public final class FastGesOrienter implements GraphSearch, GraphScorer, Reorienter {
     ...
     */
    public FastGesOrienter(DataSet dataSet) {
     ...
     */
    public FastGesOrienter(ICovarianceMatrix covMatrix) {
