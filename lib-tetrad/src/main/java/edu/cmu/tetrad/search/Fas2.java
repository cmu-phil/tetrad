 ...
 * </p>
 * This uses a somewhat different algorithms from FAS, probably better.
 *
...
//    private List<Double> pValues = new ArrayList<Double>();
     ...
     */
    public Fas2(Graph graph, IndependenceTest test) {
        this.graph = graph;
        this.test = test;
    }
...
//                            if (verbose) {
//                                out.println(SearchLogUtils.dependenceFactMsg(x, y, condSet, test.getPValue()) + " p = " +
//                                        nf.format(test.getPValue()));
//                            }
