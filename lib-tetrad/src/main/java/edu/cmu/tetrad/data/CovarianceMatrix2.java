 ...
 */
public class CovarianceMatrix2 implements ICovarianceMatrix {
...
//        this.matrix = DataUtils.cov(data);
        ...
        this.matrix = DataUtils.cov(dataSet.getDoubleData());
    }
     ...
     */
    public CovarianceMatrix2(List<Node> variables, TetradMatrix matrix,
                             int sampleSize) {
     ...
     * Copy constructor.
     */
    public CovarianceMatrix2(CovarianceMatrix2 covMatrix) {
        this(covMatrix.variables, covMatrix.matrix,
                covMatrix.sampleSize);
    }

    public CovarianceMatrix2(ICovarianceMatrix covMatrix) {
    ...
    public static ICovarianceMatrix serializableInstance() {
        ...
        return new CovarianceMatrix2(variables, matrix, 100);
    }
    ...
    public final ICovarianceMatrix getSubmatrix(int[] indices) {
        ...
        return new CovarianceMatrix2(submatrixVars, cov, getSampleSize());
    }
     ...
     * order.
     */
    public final CovarianceMatrix2 getSubmatrix(String[] submatrixVarNames) {
        List<Node> submatrixVars = new LinkedList<Node>();
