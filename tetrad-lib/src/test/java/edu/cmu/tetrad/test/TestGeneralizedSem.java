...
public class TestGeneralizedSem {
    ...
    public void test1() {
        ...
        this.print(variablesNodes);

        List<Node> errorNodes = pm.getErrorNodes();
        this.print(errorNodes);
        ...
        try {
            ...
            this.print("Parameters referenced by X3 are: " + referencedParameters);
...
//
            for (Node node : pm.getNodes()) {
                ...
                this.print("Nodes referencing " + node + " are: " + referencingNodes);
            }

            for (Node node : pm.getVariableNodes()) {
                Set<Node> referencingNodes = pm.getReferencedNodes(node);
                this.print("Nodes referenced by " + node + " are: " + referencingNodes);
            }
...
//            System.out.println(dataSet);
    ...
    public void test4() {
        ...
        for (String template : templates.keySet()) {
            ...
            this.print(semPm.getGraph().toString());
            ...
            for (int i = 0; i < semPm.getNodes().size(); i++) {
                this.print("-----------");
                this.print(semPm.getNodes().get(i).toString());
                this.print("Trying template: " + template);
                ...
                try {
                    ...
                    this.print("Couldn't expand template: " + template);
                    continue;
                }

                try {
                    semPm.setNodeExpression(node, _template);
                    this.print("Set formula " + _template + " for " + node);
                    ...
                    this.print("Couldn't set formula " + _template + " for " + node);
                }
            }
            ...
            for (String parameter : semPm.getParameters()) {
                ...
                try {
                    ...
                    this.print("Set formula " + _template + " for " + parameter);
                } catch (Exception e) {
                    this.print("Couldn't set formula " + _template + " for " + parameter);
                }
            }
    ...
    public void test5() {
        ...
        this.print("XXX1" + e);
        this.print("XXX2" + record1);
        this.print("XXX3" + record2);
    ...
    public void test6() {
        ...
        this.print(estIm);
        this.print(estimator.getReport());
