...
public class TestMimbuild {
    ...
    public void test1() {
        ...
        for (int r = 0; r < 1; r++) {
            ...
            Graph mimStructure = this.structure(mim);
            ...
            List<String> latentVarList = this.reidentifyVariables(mim, data, partition, 2);
    ...
    private Graph changeLatentNames(Graph full, Clusters measurements, List<String> latentVarList) {
        ...
        for (int i = 0; i < measurements.getNumClusters(); i++) {
            ...
            for (Node node : full.getNodes()) {
                ...
                List<String> childNames = this.getNames(_children);
