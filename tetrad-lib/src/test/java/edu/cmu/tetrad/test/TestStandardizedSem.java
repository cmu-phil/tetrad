...
public class TestStandardizedSem {
    ...
    public void test1() {
        ...
        assertTrue(this.isStandardized(sem));
    }
    ...
    public void test4() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            ParameterRange range = sem.getCoefficientRange(a, b);
        ...
        for (int i = 0; i < 1; i++) {
            for (Edge edge : graph.getEdges()) {
                ...
                if (Edges.isDirectedEdge(edge)) {
                    ...
                    ParameterRange range2 = sem.getCovarianceRange(a, b);
    ...
    public void testSliderValues() {
        ...
        for (int i = 0; i <= 100; i++) {
            assertEquals(i, this.sliderToSlider(i, -5, 5, n));
        }

        for (int i = 0; i <= 100; i++) {
            assertEquals(i, this.sliderToSlider(i, -5, Double.POSITIVE_INFINITY, n));
        }

        for (int i = 0; i <= 100; i++) {
            assertEquals(i, this.sliderToSlider(i, Double.NEGATIVE_INFINITY, 5, n));
        }

        for (int i = 0; i <= 100; i++) {
            assertEquals(i, this.sliderToSlider(i, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, n));
        }
