...
//            out = outClosure(out);
            ...
            for (Edge edge : out.getEdges()) {
                ...
                if (edge.getEndpoint1() == Endpoint.ARROW) {
                    if (!dag.getPaths().isAncestorOf(edge.getNode1(), edge.getNode2()) &&
                            dag.getPaths().existsTrek(edge.getNode1(), edge.getNode2())) {
                        arrowsTp++;
                    } else {
                        arrowsFp++;
                    }
                ...
                if (edge.getEndpoint2() == Endpoint.ARROW) {
                    if (!dag.getPaths().isAncestorOf(edge.getNode2(), edge.getNode1()) &&
                            dag.getPaths().existsTrek(edge.getNode1(), edge.getNode2())) {
                        arrowsTp++;
                    } else {
                        arrowsFp++;
                ...
                if (edge.getEndpoint1() == Endpoint.TAIL) {
                    if (dag.getPaths().existsDirectedPathFromTo(edge.getNode1(), edge.getNode2())) {
                        tailsTp++;
                    } else {
                        tailsFp++;
                    }
                ...
                if (edge.getEndpoint2() == Endpoint.TAIL) {
                    if (dag.getPaths().existsDirectedPathFromTo(edge.getNode2(), edge.getNode1())) {
                        tailsTp++;
                    } else {
                        tailsFp++;
                    }
                ...
                if (Edges.isBidirectedEdge(edge)) {
                    if (!dag.getPaths().isAncestorOf(edge.getNode1(), edge.getNode2())
                            && !dag.getPaths().isAncestorOf(edge.getNode2(), edge.getNode1())
                            && dag.getPaths().existsTrek(edge.getNode1(), edge.getNode2())) {
                        bidirectedTp++;
                    } else {
                        bidirectedFp++;
        ...
        for (Node n : out.getNodes()) {
            for (Node m : out.getNodesOutTo(n, Endpoint.ARROW)) {
                ...
                if (proximalEndpoint == Endpoint.CIRCLE || proximalEndpoint == Endpoint.TAIL) {
                    List<Node> descendants = out.getPaths().getDescendants(Collections.singletonList(m));
