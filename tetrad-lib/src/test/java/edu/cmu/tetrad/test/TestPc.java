...
public class TestPc {
    ...
    public void testSearch4() {
        ...
        this.checkWithKnowledge("A-->B,C-->B,B-->D", "A---B,B-->C,D",
                knowledge);
    }
    ...
    public void testPcFci() {
        ...
        for (int numLatents = 0; numLatents <= maxLatents; numLatents += jumpLatents) {
            ...
            for (int t = 0; t < algorithms.length; t++) {
                allRet[t] = this.printStats(algorithms, t, true, numRuns, alpha, penaltyDiscount, maxLatents,
        ...
        this.printBestStats(allAllRet, algorithms, statLabels, maxLatents, jumpLatents, ofInterestCutoff);
    }
...
//                double maxStat = Double.NaN;
    ...
    public void testPcRegression() {
        ...
        for (int numLatents = 0; numLatents <= maxLatents; numLatents += jumpLatents) {
            ...
            for (int t = 0; t < algorithms.length; t++) {
                allRet[t] = this.printStatsPcRegression(algorithms, t, true, numRuns, alpha, penaltyDiscount, maxLatents,
...
//            Graph comparison = new Pc(new IndTestDSep(dag)).search();
            ...
            switch (t) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    out = this.getRegressionGraph(data, target);
                    break;
                default:
                    throw new IllegalStateException();
            }
