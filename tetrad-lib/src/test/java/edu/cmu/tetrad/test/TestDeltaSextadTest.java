...
//        Node x1 = data.getCause(indices.get(0));
//        Node x2 = data.getCause(indices.get(1));
//        Node x3 = data.getCause(indices.get(2));
//        Node x4 = data.getCause(indices.get(3));
//        Node x5 = data.getCause(indices.get(4));
//        Node x6 = data.getCause(indices.get(5));
