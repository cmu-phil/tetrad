...
//        Node x1 = data.getPredictor(indices.get(0));
//        Node x2 = data.getPredictor(indices.get(1));
//        Node x3 = data.getPredictor(indices.get(2));
//        Node x4 = data.getPredictor(indices.get(3));
//        Node x5 = data.getPredictor(indices.get(4));
//        Node x6 = data.getPredictor(indices.get(5));
