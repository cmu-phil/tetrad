 ...
 */
public final class CgParameter implements TetradSerializable {
    ...
    private final int childCategoryNo;
    
    private final int conditionalCaseNo;
     ...
     */
    public CgParameter(String name, ParamType type, Node nodeA, Node nodeB, int childCategoryNo, int conditionalCaseNo) {
        if (name == null) {
        ...
        this.nodeA = nodeA;
        this.nodeB = nodeB;
        this.childCategoryNo = childCategoryNo;
        this.conditionalCaseNo = conditionalCaseNo;
    }
    
    public CgParameter(String name, ParamType type, Node nodeA, Node nodeB, int conditionalCaseNo) {
    	this(name, type, nodeA, nodeB, 0, conditionalCaseNo);
    }

    /**
     * Generates a simple exemplar of this class to test serialization.
     */
    public static CgParameter serializableInstance() {
        return new CgParameter("X", ParamType.COEF, new GraphNode("X"),
                new GraphNode("Y"), 0, 0);
    }
    ...
    public int getChildCategoryNo() {
    	return childCategoryNo;
    }
    
	public int getConditionalCaseNo() {
		return conditionalCaseNo;
	}
}
