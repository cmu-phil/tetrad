...
public class EigenDecomposition {
    ...
    public EigenDecomposition(RealMatrix matrix)
        ...
        if (isSymmetric) {
            ...
            this.findEigenVectors(transformer.getQ().getData());
        } else {
    ...
    private static class Solver implements DecompositionSolver {
        ...
        public boolean isNonSingular() {
            ...
            for (int i = 0; i < realEigenvalues.length; ++i) {
                ...
                if (Precision.equals(this.eigenvalueNorm(i) / largestEigenvalueNorm, 0, EPSILON)) {
                    return false;
                }
            }
            return true;
        ...
        for (int idx = n - 1; idx >= 0; idx--) {
            ...
            if (Precision.equals(q, 0.0)) {
                ...
                if (FastMath.abs(matrixT[idx][idx - 1]) > FastMath.abs(matrixT[idx - 1][idx])) {
                    ...
                    Complex result = this.cdiv(0.0, -matrixT[idx - 1][idx],
                ...
                for (int i = idx - 2; i >= 0; i--) {
                    ...
                    if (Precision.compareTo(imagEigenvalues[i], 0.0, EPSILON) < 0) {
                        ...
                        if (Precision.equals(imagEigenvalues[i], 0.0)) {
                            ...
                            Complex c = this.cdiv(x * r - z * ra + q * sa,
                                    x * s - z * sa - q * ra, vr, vi);
                            matrixT[i][idx - 1] = c.getReal();
                            matrixT[i][idx] = c.getImaginary();
                            ...
                            if (FastMath.abs(x) > (FastMath.abs(z) + FastMath.abs(q))) {
                                ...
                                Complex c2 = this.cdiv(-r - y * matrixT[i][idx - 1],
