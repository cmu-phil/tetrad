 ...
 */
@Experimental
public class MagDgBicScore implements Score {

    private final DegenerateGaussianScore score;
     ...
     */
    public MagDgBicScore(DataSet dataSet) {
        if (dataSet == null) {
     ...
     */
    public MagDgBicScore(DataSet dataSet, boolean precomputeCovariances) {
        if (dataSet == null) {
            throw new NullPointerException();
        }
