...
public class BasisFunctionTestScratch implements IndependenceTest {
    ...
    public BasisFunctionTestScratch(DataSet dataSet, int truncationLimit,
    ...
    public BasisFunctionTestScratch() {
        this.dataSet = null;
        this.variables = null;
        this.nodeHash = null;
        this.embedding = null;
    ...
    public static void main(String[] args) {
        ...
        BasisFunctionTestScratch test = new BasisFunctionTestScratch();
