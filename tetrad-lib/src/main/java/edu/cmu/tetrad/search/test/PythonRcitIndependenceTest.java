...
/**
 * The PythonRcitIndependenceTest class implements an independence test using the kernel
 * conditional independence (RCIT) test provided through a Python backend, such as
 ...
 * - Care is required when modifying properties (alpha, verbosity, or RCIT parameters),
 ...
 * - Executes the RCIT test by delegating the computation to the Python service.
 ...
 */
public final class PythonRcitIndependenceTest implements IndependenceTest, Closeable {
    ...
    // Any RCIT parameters you want to forward
    private final Map<String, Object> rcitParams = new HashMap<>();

    /**
     * Constructs a PythonRcitIndependenceTest object for performing conditional independence tests
     ...
     */
    public PythonRcitIndependenceTest(DataSet data, PythonCiService service) {
        ...
        service.initializeIfNeeded(data, vars, rcitParams);
    }
    ...
    /**
     * Indicates whether verbose output is enabled for the PythonRcitIndependenceTest.
     *
    ...
    /**
     * Sets whether verbose output is enabled for this instance of PythonRcitIndependenceTest.
    ...
    /**
     * Returns a string representation of the PythonRcitIndependenceTest instance, providing
     * a concise description intended to identify the use of the RCIT method for causal independence
     * tests integrated with a Python backend.
     *
     * @return a string describing the PythonRcitIndependenceTest implementation.
     */
    @Override
    public String toString() {
        return "RCIT (Python / causal-learn)";
    }

    /**
     * Sets a RCIT-specific parameter for the PythonRcitIndependenceTest instance. This method allows
     ...
     */
    // Optional: allow setting RCIT-specific parameters via your Parameters plumbing
    public void setKciParam(String key, Object value) {
        rcitParams.put(key, value);
