...
public class CpdagParentDistancesFromTrue {
    ...
    private static double[][] copy2DArray(double[][] original) {
        if (original == null) {
            return null;  // Handle the case where the original array is null.
        }
...
//        System.out.println("max = " + new Matrix(maxCoef));
        ...
        return copy2DArray(distances);
    }

    /**
     * Returns a copy of the minimum coefficient matrices.
     *
     * @return A copy of the minimum coefficient matrices.
     */
    public double[][] getMinCoef() {
        return copy2DArray(minCoef);
    }

    /**
     * Returns a copy of the maximum coefficient matrices.
     *
     * @return A copy of the maximum coefficient matrices.
     */
    public double[][] getMaxCoef() {
        return copy2DArray(maxCoef);
    }
