...
public class TetradTestPopulation implements TetradTest {
    ...
    public int tetradScore(int v1, int v2, int v3, int v4) {
        ...
        if (TMath.abs(p_12 * p_34 - p_13 * p_24) < this.epsilon) {
            count++;
            this.bvalues[0] = true;
        }
        if (TMath.abs(p_12 * p_34 - p_14 * p_23) < this.epsilon) {
            count++;
            this.bvalues[1] = true;
        }
        if (TMath.abs(p_13 * p_24 - p_14 * p_23) < this.epsilon) {
            count++;
            this.bvalues[2] = true;
        }
        return count;
    ...
    public boolean tetradHolds(int v1, int v2, int v3, int v4) {
        ...
        double p_24 = this.CorrelationMatrix.getValue(v2, v4);
        double p_34 = this.CorrelationMatrix.getValue(v3, v4);
        this.bvalues[0] = TMath.abs(p_12 * p_34 - p_13 * p_24) < this.epsilon;
