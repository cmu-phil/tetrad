...
/**
 * Utility class for operations related to Gaussian Mixture Models (GMMs) in the context of Expectation-Maximization
 * (EM) algorithms. This class provides methods for evaluating model quality and handling membership probabilities.
