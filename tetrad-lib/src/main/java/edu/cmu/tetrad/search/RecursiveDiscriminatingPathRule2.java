 ...
 * @author josephramsey
 */
public class RecursiveDiscriminatingPathRule2 {
     ...
     */
    private RecursiveDiscriminatingPathRule2() {
    ...
    public static Set<Node> findDdpSepsetRecursive(IndependenceTest test, Graph pag, Node x, Node y,
        ...
        while ((choice2 = gen1.next()) != null) {
            ...
            for (int[] indices : allChoices) {
                ...
                Set<Node> sepset = SepsetFinder2.findSepset(pag, x, y, vNodesNotFollowed, -1,
                    new SepsetFinder2.StandardSepsetTester(pag, true));
