 ...
 * @deprecated Use DegenerateGaussianScore
 */
public class DegenerateGaussianScoreOld implements Score {
    ...
    public double localScore(int i, int... parents) {
        ...
        int N = dataSet.getNumRows();// rows.size();
        ...
        double lik = N * (ldetB - ldetA + DegenerateGaussianScoreOld.L2PE * (B_.length - A_.length));
