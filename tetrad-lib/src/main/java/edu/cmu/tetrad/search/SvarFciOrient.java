...
public final class SvarFciOrient {
     ...
     */
    public SvarFciOrient(final SepsetProducer sepsets, final IndependenceTest independenceTest) {
...
//            if (!knowledge.isForbidden(x.getName(), y.getName())) return true;
    ...
    private void orientSimilarPairs(final Graph graph, final IKnowledge knowledge, final Node x, final Node y, final Endpoint mark) {
