...
//    }
    ...
    /**
     * Median of pairwise squared Euclidean distances for an n×d matrix Z.
     * Uses all pairs (i<j). Returns the median of strictly-positive distances if possible,
     * otherwise returns 1.0 as a safe fallback.
     */
     ...
     *
     * Bandwidth heuristic:
     *   bw2 = median_{i<j} (xi-xj)^2   on up to maxBWPoints points.
     *
    ...
    /**
     * Median of pairwise squared distances for 1D data.
     * Uses a uniform subsample without replacement of size m (<= n) for speed.
     *
