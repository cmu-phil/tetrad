 ...
 * </ul>
 */
public final class MinimaxTRffCITest3a implements IndependenceTest, RowsSettable {
    ...
    public MinimaxTRffCITest3a(DataSet data, double alpha) {
        ...
        // 	•	rffFeatures = 96
        //	•	ridge = 1e-2
        //	•	binsPerContZ = 3 (and if |Z| ≤ 1, allow 6)
        //	•	minStratumSize = 12
        //	•	permutations = 500
    }
