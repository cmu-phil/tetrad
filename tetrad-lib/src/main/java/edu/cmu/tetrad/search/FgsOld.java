 ...
 */
public final class FgsOld implements GraphSearch, GraphScorer {
     ...
     * @deprecated Construct a Score and pass it in instead.
     */
    public FgsOld(ICovarianceMatrix covMatrix) {
        if (verbose) {
            out.println("GES constructor");
        }
