...
import edu.cmu.tetrad.search.DmMgBoss;
 ...
 * @author josephramsey
 */
public final class DmMgBossRunner implements MimicSearchRunner {
    ...
    public Graph run(DataSet data, Knowledge knowledge, List<Node> inputs, List<Node> outputs, Parameters parameters) {
        ...
        Score score = new SemBicScore().getScore(data, parameters);
        ...
        DmMgBoss search = new DmMgBoss(test, score);
