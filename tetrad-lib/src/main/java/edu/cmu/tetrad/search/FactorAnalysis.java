...
public class FactorAnalysis {
     ...
     * <p>
     * We stop looking for new vectors either when we've accounted for close to all of the variance in the original
     ...
     * accounts for any more variance).  This means we've already "pulled out" all of the variance we can from the
     * residual matrix, and we should stop as further factors don't explain much more (and serve to complicate the
     * model).
     * <p>
     * PSEUDO-CODE:
     * <p>
     ...
     * other words, while we haven't accounted for practically all of the variance):
     * <p>
     ...
     * vector, and finds both the factor loading vector and the "d scalar" which is used to determine the amount of
