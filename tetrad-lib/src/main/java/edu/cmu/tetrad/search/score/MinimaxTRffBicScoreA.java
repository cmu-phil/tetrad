     ...
     * </p>
     */
    public final class MinimaxTRffBicScoreA implements Score, EffectiveSampleSizeSettable {
         ...
         */
        public MinimaxTRffBicScoreA(DataSet dataSet) {
        ...
        private FitResult fitStudentTRffRidgeMixed(double[] yCentered, int[] parentIdx, int[] rows, int n, long seed) {
            ...
            // EDF using last weights, but only penalized block contributes to ridge EDF correction
            ...
            double trInvPen = traceInvPenalizedBlockFromG(Gfinal);
