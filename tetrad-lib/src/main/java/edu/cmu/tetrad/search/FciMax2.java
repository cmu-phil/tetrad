 ...
 */
public final class FciMax2 implements GraphSearch {
     ...
     */
    public FciMax2(IndependenceTest independenceTest) {
     ...
     * search over.
     */
    public FciMax2(IndependenceTest independenceTest, List<Node> searchVars) {
        if (independenceTest == null) {
            throw new NullPointerException();
        }
