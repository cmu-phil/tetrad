 ...
 */
public class SemBicScoreAdditionalFacts implements Score {

    private final Set<IndependenceFact> facts;
     ...
     */
    public SemBicScoreAdditionalFacts(ICovarianceMatrix covariances, Set<IndependenceFact> facts) {
        if (covariances == null) {
...
//            System.out.println(SearchLogUtils.determinismDetected(_z, _x));
        ...
        if (Double.isNaN(r)) {
            if (facts.contains(new IndependenceFact(_x, _y, _z))) return .00001;
        }
