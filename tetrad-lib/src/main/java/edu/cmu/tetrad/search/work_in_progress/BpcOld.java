...
public final class BpcOld {
     ...
     * @see BpcTestType
     */
    public BpcOld(CorrelationMatrix covarianceMatrix, double alpha, BpcTestType sigTestType) {
     ...
     * @see BpcTestType
     */
    public BpcOld(DataSet dataSet, double alpha, BpcTestType sigTestType) {
