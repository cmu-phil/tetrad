...
/**
 * Naming convention tests for giveGoodLatentNames(...). Assumes the method is available in scope, e.g.,
 * BlockSpecUtil.giveGoodLatentNames(...) Adjust the static imports / class names to match your codebase.
 */
