...
public final class MimBuild {
    ...
    private TetradMatrix latentsCov = new TetradMatrix(0, 0);
    private List<String> latentNames = new ArrayList<String>();

    public MimBuild(IndTestMimBuild indTest, IKnowledge knowledge) {
...
//            Dag dag = new Dag(directedStructuralModel);
