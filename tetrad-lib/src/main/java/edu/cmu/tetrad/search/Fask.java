 ...
 * hallucinated) if the threshold is set higher.
 *
 ...
 *
 * It is assumed that the data are arranged so the each variable forms a column and that there are not missing
 * value. The data matrix is assumed to be rectangular. To this end, the Tetrad DataSet class is used, which
 * enforces this.
 *
