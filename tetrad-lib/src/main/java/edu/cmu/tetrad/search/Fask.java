...
public final class Fask {
    ...
    public static double cu(double[] x, double[] y, double[] condition) {
        double exy = 0.0; int n = 0;
        for (int k = 0; k < x.length; k++) if (condition[k] > 0) { exy += x[k]*y[k]; n++; }
        return exy / n;
    }
    ...
    public static double E(double[] x, double[] y, double[] z) {
        double exy = 0.0; int n = 0;
        for (int k = 0; k < x.length; k++) if (z[k] > 0) { exy += x[k]*y[k]; n++; }
        return exy / n;
    }
    ...
    private static double g(double x) { return log(cosh(FastMath.max(x, 0))); }
    ...
    // ------------ Config ------------
    public void setLeftRight(Fask.LeftRight leftRight) { this.leftRight = leftRight; }
    ...
    public void setExternalGraph(Graph externalGraph) { this.externalGraph = externalGraph; }
    public void setExtraEdgeThreshold(double extraEdgeThreshold) { this.extraEdgeThreshold = extraEdgeThreshold; }
    public void setUseFasAdjacencies(boolean useFasAdjacencies) { this.useFasAdjacencies = useFasAdjacencies; }
    public void setUseSkewAdjacencies(boolean useSkewAdjacencies) { this.useSkewAdjacencies = useSkewAdjacencies; }
    ...
    private boolean bidirected(double[] x, double[] y, Graph G0, Node X, Node Y) {
        ...
        while ((choice = gen.next()) != null) {
            ...
            if (!possibleTwoCycle) return false;
        }
        return true;
    }
