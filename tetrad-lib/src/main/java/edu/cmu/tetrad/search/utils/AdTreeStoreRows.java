...
public class AdTreeStoreRows {
     ...
     */
    public AdTreeStoreRows(DataSet dataSet) {
     ...
     */
    public AdTreeStoreRows(DataSet dataSet, List<Integer> rows) {
...
//            }
     ...
     */
    private record Subdivision(AdTreeStoreRows.Subdivision previousSubdivision, int category, List<Integer> cell) {
    }
}
