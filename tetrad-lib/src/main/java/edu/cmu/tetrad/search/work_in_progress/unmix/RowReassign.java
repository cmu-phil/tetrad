...
/**
 * Utilities for reassigning rows to clusters under a diagonal-Gaussian model of residuals.
 */
public final class RowReassign {

    /**
     * Reassigns rows to clusters by minimizing the diagonal-Gaussian score: sum_j r_ij^2 / s2_kj + log s2_kj, where
     * s2_kj are per-cluster per-column variances estimated from current labels.
     *
     * @param R      residual matrix of shape n x p
     * @param labels current cluster labels (length n)
     * @param K      number of clusters
     * @return new labels after one reassignment pass
     */
