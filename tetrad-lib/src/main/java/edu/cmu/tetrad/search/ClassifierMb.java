 ...
 */
public class ClassifierMb implements DiscreteClassifier {
    ...
    public ClassifierMb(String trainPath, String testPath, String targetString,
    ...
    public static void main(String[] args) {
        ...
        new ClassifierMb(trainPath, testPath, targetString, alphaString, depthString,
