 ...
 */
public class PcMaxTriple2 implements GraphSearch {
     ...
     */
    public PcMaxTriple2(IndependenceTest independenceTest) {
    ...
    private void doNode2(Graph graph, Map<Triple, Double> colliders, Node b, SepsetMap sepsetMap) {
        ...
        while ((combination = cg.next()) != null) {
            ...
            List<Node> cond = sepsetMap.get(a, c);

            List<Node> cond2 = new ArrayList<>(cond);
            ...
            independenceTest.isIndependent(a, c, cond);
            double s1 = independenceTest.getScore();
            independenceTest.isIndependent(a, c, cond2);
