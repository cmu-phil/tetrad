 ...
 * The default is {@code false}, which preserves the original full-invalidation
 * behavior exactly.
 *
...
//    };
    ...
    /**
     * When true, GLOBAL_QUEUE recomputes candidates only for vertices affected by each
     * applied edit; see {@link #setAffectedOnlyInvalidation(boolean)}.
     */
    private boolean affectedOnlyInvalidation = false;
     ...
     * </ul>
     *
     * <p>The default is {@code false}, preserving the original full-invalidation
     * behavior exactly.
     *
