 ...
 */
public class VertexCheckIndTestModel {
    ...
    private CachedIndependenceQueries cachedQueries;
    private Graph graph;
    ...
    private ConditioningSetType conditioningSetType = ConditioningSetType.ORDERED_LOCAL_MARKOV_MAG;
    ...
    public VertexCheckIndTestModel(IndependenceTest test, Graph graph, Knowledge knowledge, ConditioningSetType conditioningSetType,
                                   Parameters parameters) {
        this.independenceTest = test;
        this.graph = graph;
        this.conditioningSetType = conditioningSetType;
        this.parameters = parameters;
        this.cachedQueries = new CachedIndependenceQueries(test);
...
//    }
    ...
    /**
     * @param suffix null if no numeric suffix
     */
    private record NaturalKey(String prefix, Integer suffix) implements Comparable<NaturalKey> {
