 ...
 * from a dataset. It is based on the assumption that the data are generated by a
 * linear model with non-Gaussian noise. The method is based on the following assumptions:</p>
 *
 * <ol>
