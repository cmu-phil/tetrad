 ...
 */
public final class ClassifierBayesUpdater
    ...
    public ClassifierBayesUpdater(BayesIm bayesIm,
                                  DataSet testData) {
        if (bayesIm == null) {
     ...
     */
    public static ClassifierBayesUpdater serializableInstance() {
        return new ClassifierBayesUpdater(MlBayesIm.serializableInstance(),
