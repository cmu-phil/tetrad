 ...
 * @see Boss
 */
public final class BossFciCheckPag extends StarFciCheckPag {
    /**
     * The score.
     */
     ...
     * </p>
     *
     * @see BossFciCheckPag#setNumStarts(int)
     * @see BossFciCheckPag#search()
     */
     ...
     * @see Score
     */
    public BossFciCheckPag(IndependenceTest test, Score score) {
        super(test);
        if (score == null) {
     ...
     * resulting graph. The algorithm is initialized and configured based on the current state of the BOSS-FCI instance,
