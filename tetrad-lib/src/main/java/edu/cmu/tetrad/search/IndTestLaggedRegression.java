...
//        regressors.add(dataSet.getCause(yVar.getNode()));
//
//        for (Node zVar : zList) {
//            regressors.add(dataSet.getCause(zVar.getNode()));
//        }
...
//
//        int xIndex = getCause().indexOf(xVar);
//
//        for (int i = 0; i < zList.size(); i++) {
//            zCols[i] = getCause().indexOf(zList.get(i));
//        }
//
