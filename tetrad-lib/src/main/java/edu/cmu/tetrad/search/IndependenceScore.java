 ...
 */
public class IndependenceScore implements Score {
     ...
     */
    public IndependenceScore(IndependenceTest test) {
        this.test = test;
...
//        return localScore(y, x) - localScore(y);
    ...
    private double locallyConsistentScoringCriterion(int x, int y, int[] z) {
        ...
        boolean independent = test.isIndependent(_x, _y, _z);
