...
//        out.println("# Edges = " + (int) (numVars * edgeFactor));
    ...
    public void testPcStableMax(int numVars, double edgeFactor, int numCases, double alpha) {
        ...
        this.init(new File("long.pcstablemax." + numVars + "." + edgeFactor + "." + alpha + ".txt"), "Tests performance of the PC Max algorithm");
...
//        RandomUtil.getInstance().setSeed(50304050454L);
        ...
        if (continuous) {
            this.init(new File("fges.comparison.continuous" + numVars + "." + (int) (edgeFactor * numVars) +
            ...
            this.init(new File("fges.comparison.discrete" + numVars + "." + (int) (edgeFactor * numVars) +
                    "." + numCases + "." + numRuns + ".txt"), "Num runs = " + numRuns);
            out.println("Num vars = " + numVars);
            out.println("Num edges = " + (int) (numVars * edgeFactor));
            out.println("Num cases = " + numCases);
...
//            comparison[1] = trueAdj / (double) (trueAdj + adjFn);
            ...
            out.println(this.precisionRecall(comparison));
        ...
        this.printAverageConfusion("Average", allCounts);
...
//        boolean faithfulness = false;
        ...
        if (continuous) {
            this.init(new File("FgesMb.comparison.continuous" + numVars + "." + (int) (edgeFactor * numVars) +
                    "." + numCases + "." + numRuns + ".txt"), "Num runs = " + numRuns);
            out.println("Num vars = " + numVars);
            out.println("Num edges = " + (int) (numVars * edgeFactor));
            out.println("Num cases = " + numCases);
...
//            fges.setHeuristicSpeedup(faithfulness);
            ...
            this.init(new File("FgesMb.comparison.discrete" + numVars + "." + (int) (edgeFactor * numVars) +
                    "." + numCases + "." + numRuns + ".txt"), "Num runs = " + numRuns);
            out.println("Num vars = " + numVars);
            out.println("Num edges = " + (int) (numVars * edgeFactor));
            out.println("Num cases = " + numCases);
...
//            printAverageConfusion("Average", allCounts);
    ...
    public void testGFciComparison(int numVars, double edgeFactor, int numCases, int numLatents) {
        ...
        this.init(new File("fci.algorithm.comparison" + numVars + "." + (int) (edgeFactor * numVars) +
        ...
        List<GraphComparison> ffciCounts = new ArrayList<>();
...
//    }
    ...
    private void printAverageConfusion(String name, List<int[][]> comparisons) {
        this.printAverageConfusion(name, comparisons, new DecimalFormat("0.0"));
    }
