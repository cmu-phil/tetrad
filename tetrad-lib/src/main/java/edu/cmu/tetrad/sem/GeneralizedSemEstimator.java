...
public class GeneralizedSemEstimator {
     ...
     *
     * @return the value of aSquaredStar
     */
...
//            0.01, 0.000001
    ...
    public static class MyContext implements Context {
         ...
         *
         * @param s         The key for the parameter value.
         * @param parameter The value to be put in the map.
         */
         ...
         *
         * @param s     The key for the variable value.
