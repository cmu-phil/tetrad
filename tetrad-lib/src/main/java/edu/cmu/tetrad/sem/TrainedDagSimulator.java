 ...
 */
public final class TrainedDagSimulator {
    ...
    public TrainedDagSimulator(DataSet data, Graph dag, Params params) {
    ...
    private static final class InputEncoder {
        ...
        private static int safeGetInt(DataSet data, int row, int col) {
            try {
    ...
    private final class ContinuousMechanism extends Mechanism {
        ...
        private int discreteSignatureFromDataRow(DataSet data, int row, InputEncoder enc) {
            ...
            for (int j = 0; j < enc.parentIdx.length; j++) {
                ...
                int v = InputEncoder.safeGetInt(data, row, col);
                h = 31 * h + v;
            }
            return h;
        }
