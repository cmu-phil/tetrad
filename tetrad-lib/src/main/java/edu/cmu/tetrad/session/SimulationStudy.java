...
public final class SimulationStudy {
    ...
    public void execute(SessionNode sessionNode, boolean overwrite) {
        ...
        nodesToExecute = session.getNodes();
//        this.nodesToExecute = nodesWithModels();
        ...
        LinkedList<SessionNode> tierOrdering = new LinkedList<>(this.getTierOrdering(sessionNode));
        ...
        this.execute(tierOrdering, doRepetition, simulation, overwrite);
    ...
    public boolean createDescendantModels(SessionNode sessionNode,
        ...
        final boolean simulation = true;
        return this.execute(tierOrdering, doRepetition, simulation, overwrite);
    }
...
//                break;
            ...
            boolean success =
                    this.execute(_tierOrdering, doRepetition, simulation, overwrite);
