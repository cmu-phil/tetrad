...
//        name = "MAG-DG-BIC (MAG Degenerate Gaussian BIC Score)",
//        command = "mag-dg-bic-score",
//        dataType = DataType.Mixed
//)
@Mixed
public class MagDgBicScore implements ScoreWrapper {
    ...
    public Score getScore(DataModel dataSet, Parameters parameters) {
        dataSet = MissingDataUtils.gate(dataSet, parameters, false, "MAG-DG-BIC (MAG Degenerate Gaussian BIC Score)");
    ...
    public String getDescription() {
        return "MAG Degenerate Gaussian BIC Score";
    }
