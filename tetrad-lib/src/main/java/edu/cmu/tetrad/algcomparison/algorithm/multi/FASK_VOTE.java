...
@Bootstrapping
public class FASK_VOTE implements MultiDataSetAlgorithm, HasKnowledge, UsesScoreWrapper, TakesIndependenceWrapper {
    ...
    public FASK_VOTE(IndependenceWrapper test, ScoreWrapper score) {
        this.test = test;
        this.score = score;
    }
    ...
    public Graph search(List<DataModel> dataSets, Parameters parameters) {
        ...
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            FASK_VOTE imagesSemBic = new FASK_VOTE(this.test, this.score);
    ...
    public Graph search(DataModel dataSet, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            FASK_VOTE imagesSemBic = new FASK_VOTE();
