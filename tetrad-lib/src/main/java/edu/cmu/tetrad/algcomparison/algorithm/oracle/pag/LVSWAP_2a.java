...
@Bootstrapping
@Experimental
public class LVSWAP_2a implements Algorithm, UsesScoreWrapper, TakesIndependenceWrapper, HasKnowledge {
    ...
    public String getDescription() {
        return "LV-Swap-2a (BOSS + swap rules) using " + this.test.getDescription()
