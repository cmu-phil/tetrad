...
@Bootstrapping
@Experimental
public class BOSSOpt implements Algorithm, UsesScoreWrapper, TakesIndependenceWrapper, HasKnowledge {
    ...
    public BOSSOpt(ScoreWrapper score, IndependenceWrapper test) {
        this.score = score;
        this.test = test;
    }
    ...
    public Graph search(DataModel dataModel, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            BossOpt boss = new BossOpt(score);
            ...
            BOSSOpt algorithm = new BOSSOpt(this.score, this.test);
    ...
    public String getDescription() {
        return "BOSSOpt (Better Order Score Search) using " + this.test.getDescription()
