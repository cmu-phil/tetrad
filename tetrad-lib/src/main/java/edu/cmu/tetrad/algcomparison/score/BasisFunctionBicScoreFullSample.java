...
/**
 * Wrapper for Basis Function BIC Score Full Sample (BF-BIC-FS), which calculates likelihoods using tabular data rather
 ...
 * @version $Id: $Id
 */
@edu.cmu.tetrad.annotation.Score(name = "BF-BIC-FS (Basis Function BIC Full Sample)", command = "bf-bic-fs", dataType = DataType.Mixed)
@Mixed
public class BasisFunctionBicScoreFullSample implements ScoreWrapper {
    ...
    public String getDescription() {
        return "Basis Function BIC Score Full Sample (BF-BIC-FS)";
    }
