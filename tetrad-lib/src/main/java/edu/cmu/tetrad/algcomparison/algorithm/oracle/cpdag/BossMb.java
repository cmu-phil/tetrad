...
@Bootstrapping
@Experimental
public class BossMb implements Algorithm, HasKnowledge, UsesScoreWrapper,
    ...
    public BossMb(ScoreWrapper score) {
        this.score = score;
    }
    ...
    public Graph search(DataModel dataSet, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            edu.cmu.tetrad.search.BossMb boss = new edu.cmu.tetrad.search.BossMb(score);
            ...
            BossMb fgesMb = new BossMb(this.score);
