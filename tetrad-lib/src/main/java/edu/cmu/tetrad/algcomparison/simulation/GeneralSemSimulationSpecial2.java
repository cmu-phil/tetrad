 ...
 * @author jdramsey
 */
public class GeneralSemSimulationSpecial2 implements Simulation {
    ...
    public GeneralSemSimulationSpecial2(RandomGraph graph) {
        this.randomGraph = graph;
    }

    public GeneralSemSimulationSpecial2(GeneralizedSemPm pm) {
    ...
    public GeneralSemSimulationSpecial2(GeneralizedSemIm im) {
