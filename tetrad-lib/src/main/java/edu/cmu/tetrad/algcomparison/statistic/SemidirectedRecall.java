...
public class SemidirectedRecall implements Statistic {
    ...
    /**
     * Calculates the Semidirected-Rec statistic, which is the proportion of (X, Y) where if there is a
     * semidirected path in the true graph, then there is also a semidirected path in the estimated graph.
     *
