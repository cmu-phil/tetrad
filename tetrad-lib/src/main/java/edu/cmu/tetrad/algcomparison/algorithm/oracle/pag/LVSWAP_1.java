...
@Bootstrapping
@Experimental
public class LVSWAP_1 implements Algorithm, UsesScoreWrapper, TakesIndependenceWrapper, HasKnowledge {
    ...
    public LVSWAP_1(IndependenceWrapper test, ScoreWrapper score) {
        this.test = test;
        this.score = score;
    }
    ...
    public Graph search(DataModel dataModel, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            LVSWAP_1 algorithm = new LVSWAP_1(this.test, this.score);
    ...
    public String getDescription() {
        return "LV-Swap-1 (BOSS + swap rules) using " + this.test.getDescription()
