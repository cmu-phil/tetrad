...
//)
@Bootstrapping
public class FASK_CONCATENATED implements MultiDataSetAlgorithm, HasKnowledge, TakesIndependenceWrapper {
    ...
    public FASK_CONCATENATED() {

    }

    public FASK_CONCATENATED(ScoreWrapper score, IndependenceWrapper test) {
        this.score = score;
        this.test = test;
    }
    ...
    public Graph search(List<DataModel> dataSets, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            FASK_CONCATENATED algorithm = new FASK_CONCATENATED(this.score, this.test);
