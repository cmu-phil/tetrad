...
@Bootstrapping
public class BFCI3 implements Algorithm, UsesScoreWrapper, TakesIndependenceWrapper, HasKnowledge {
    ...
    public BFCI3(IndependenceWrapper test, ScoreWrapper score) {
        this.test = test;
        this.score = score;
    }
    ...
    public Graph search(DataModel dataModel, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            BFci3 search = new BFci3(this.test.getTest(dataModel, parameters), this.score.getScore(dataModel, parameters));
...
//            search.setPossibleDsepSearchDone(parameters.getBoolean(Params.POSSIBLE_DSEP_DONE));
            ...
            BFCI3 algorithm = new BFCI3(this.test, this.score);
    ...
    public String getDescription() {
        return "BFCI3 (Best-order FCI 3) using " + this.test.getDescription()
