...
@Bootstrapping
@Experimental
public class GraspTol implements Algorithm, UsesScoreWrapper, TakesIndependenceWrapper,
    ...
    public Graph search(DataModel dataModel, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            edu.cmu.tetrad.search.GraspTol grasp = new edu.cmu.tetrad.search.GraspTol(test, score);
