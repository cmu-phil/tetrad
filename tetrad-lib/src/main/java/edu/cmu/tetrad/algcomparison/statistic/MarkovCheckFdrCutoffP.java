 ...
 * @author josephramsey
 */
    public class MarkovCheckFdrCutoffP implements Statistic, MarkovCheckerStatistic {
    @Serial
     ...
     */
    public MarkovCheckFdrCutoffP(IndependenceWrapper independenceWrapper, ConditioningSetType conditioningSetType,
    ...
    public double getValue(Graph trueDag, Graph trueGraph, Graph estGraph, DataModel dataModel, Parameters parameters) {
        ...
        return markovCheck.getFdrCutoff(test.getAlpha(), true, false);
    }
