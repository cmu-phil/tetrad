...
@edu.cmu.tetrad.annotation.Algorithm(
        name = "Boss-Trek-MIMIC2",
        command = "boss-trek-mimic2",
        algoType = AlgType.forbid_latent_common_causes
)
@Bootstrapping
public class BossTrekMimic2 extends AbstractBootstrapAlgorithm
    ...
    protected Graph runSearch(DataModel dataModel, Parameters parameters) throws InterruptedException {
        if (!(dataModel instanceof DataSet)) {
            throw new IllegalArgumentException("Boss-Trek-MIMIC2 requires a DataSet.");
        }
    ...
    public String getDescription() {
        return "BOSS-Trek-MIMIC2 using " + this.test.getDescription();
    }
