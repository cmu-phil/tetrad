...
@Bootstrapping
@Experimental
public class LVSWAP_4 implements Algorithm, UsesScoreWrapper, TakesIndependenceWrapper, HasKnowledge {
    ...
    public LVSWAP_4(IndependenceWrapper test, ScoreWrapper score) {
        this.test = test;
        this.score = score;
    }
    ...
    public Graph search(DataModel dataModel, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            search.setAlgType(LvSwap.AlgType.Alg4);
            ...
            LVSWAP_4 algorithm = new LVSWAP_4(this.test, this.score);
    ...
    public String getDescription() {
        return "LV-Swap-4 (BOSS + swap rules) using " + this.test.getDescription()
