 ...
 */
@Bootstrapping
public class FGES_CONCATENTED implements MultiDataSetAlgorithm, HasKnowledge {
    ...
    public FGES_CONCATENTED(ScoreWrapper score) {
        this.score = score;
    }

    public FGES_CONCATENTED(ScoreWrapper score, boolean compareToTrue) {
        this.score = score;
        this.compareToTrue = compareToTrue;
    }

    public FGES_CONCATENTED(ScoreWrapper score, Algorithm externalGraph) {
        this.score = score;
    ...
    public Graph search(List<DataModel> dataModels, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            FGES_CONCATENTED fgesConcatenated = new FGES_CONCATENTED(this.score, this.externalGraph);
