...
@edu.cmu.tetrad.annotation.Algorithm(
        name = "DM-LV-Lite-2",
        command = "dm-lv-lite-2",
        algoType = AlgType.allow_latent_common_causes
)
@Bootstrapping
@Experimental
public class DmLvLite2 extends AbstractBootstrapAlgorithm implements Algorithm, UsesScoreWrapper, TakesIndependenceWrapper,
     ...
     * @see Algorithm
     */
    public DmLvLite2(IndependenceWrapper test, ScoreWrapper score) {
        this.test = test;
        this.score = score;
    }
    ...
    public String getDescription() {
        return "DM-LV-Lite-2 using " + this.score.getDescription();
    }
