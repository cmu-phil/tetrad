...
@Bootstrapping
@Experimental
public class FcitMarkov extends AbstractBootstrapAlgorithm implements Algorithm, TakesScoreWrapper, TakesIndependenceWrapper,
     ...
     * @see Algorithm
     */
    public FcitMarkov(IndependenceWrapper test, ScoreWrapper score) {
        this.test = test;
        this.score = score;
    }
    ...
    public Graph runSearch(DataModel dataModel, Parameters parameters) throws InterruptedException {
        ...
        edu.cmu.tetrad.search.FcitMarkov search = new edu.cmu.tetrad.search.FcitMarkov(test, score);
        ...
        if (parameters.getInt(Params.FCIT_STARTS_WITH) == 1) {
            search.setStartWith(edu.cmu.tetrad.search.FcitMarkov.START_WITH.BOSS);
        } else if (parameters.getInt(Params.FCIT_STARTS_WITH) == 2) {
            search.setStartWith(edu.cmu.tetrad.search.FcitMarkov.START_WITH.GRASP);
        } else if (parameters.getInt(Params.FCIT_STARTS_WITH) == 3) {
            search.setStartWith(edu.cmu.tetrad.search.FcitMarkov.START_WITH.SP);
        } else if (parameters.getInt(Params.FCIT_STARTS_WITH) == 4) {
            search.setStartWith(edu.cmu.tetrad.search.FcitMarkov.START_WITH.COMPLETE_GRAPH);
        } else {
    ...
    public String getDescription() {
        return "FCIT-Markov (FCI Targeted Testing Markov) using "+ this.test.getDescription() + " and " + this.score.getDescription();
    }
