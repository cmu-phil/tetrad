...
@edu.cmu.tetrad.annotation.Algorithm(
        ...
        command = "king-of-bridges",
        algoType = AlgType.forbid_latent_common_causes
)
@Bootstrapping
@Experimental
public class KING_OF_BRIDGES implements Algorithm, UsesScoreWrapper, HasKnowledge {
    ...
    public KING_OF_BRIDGES(ScoreWrapper score) {
        this.score = score;
    }
    ...
    public String getDescription() {
        return "KING_OF_BRIDGES using " + this.score.getDescription();
    }
