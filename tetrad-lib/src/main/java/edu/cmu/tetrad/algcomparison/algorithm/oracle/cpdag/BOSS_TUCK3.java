...
import edu.cmu.tetrad.search.BossTuck3;
...
@Bootstrapping
@Experimental
public class BOSS_TUCK3 implements Algorithm, HasKnowledge, UsesScoreWrapper {
    ...
    public BOSS_TUCK3(ScoreWrapper score) {
        this.score = score;
    }
    ...
    public Graph search(DataModel dataSet, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            BossTuck3 boss = new BossTuck3(score);
            ...
            BOSS_TUCK3 fgesMb = new BOSS_TUCK3(this.score);
    ...
    public String getDescription() {
        return "BOSS-Tuck3 using " + this.score.getDescription();
    }
