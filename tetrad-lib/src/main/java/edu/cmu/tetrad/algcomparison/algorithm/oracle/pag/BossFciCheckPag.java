...
@Bootstrapping
//@Experimental
public class BossFciCheckPag extends AbstractBootstrapAlgorithm implements Algorithm, TakesScoreWrapper,
     ...
     */
    public BossFciCheckPag(IndependenceWrapper test, ScoreWrapper score) {
        this.test = test;
        this.score = score;
    }
    ...
    public Graph runSearch(DataModel dataModel, Parameters parameters) throws InterruptedException {
        ...
        edu.cmu.tetrad.search.BossFciCheckPag search = new edu.cmu.tetrad.search.BossFciCheckPag(this.test.getTest(dataModel, parameters), this.score.getScore(dataModel, parameters));
    ...
    public String getDescription() {
        return "BOSS-FCI-CP using " + this.test.getDescription() + " and " + this.score.getDescription();
    }
