...
@Bootstrapping
public class Fges3 implements Algorithm, TakesInitialGraph, HasKnowledge, UsesScoreWrapper {
    ...
    public Fges3(ScoreWrapper score) {
        this.score = score;
        this.compareToTrue = false;
    }

    public Fges3(ScoreWrapper score, boolean compareToTrueGraph) {
        this.score = score;
        this.compareToTrue = compareToTrueGraph;
    }

    public Fges3(ScoreWrapper score, Algorithm algorithm) {
        this.score = score;
...
//                initialGraph = algorithm.search(dataSet, parameters);
            ...
            edu.cmu.tetrad.search.Fges3 search
                    = new edu.cmu.tetrad.search.Fges3(score.getScore(dataSet, parameters), Runtime.getRuntime().availableProcessors());
            ...
            Fges3 fges = new Fges3(score, algorithm);
