...
@Bootstrapping
@Experimental
public class P2 extends AbstractBootstrapAlgorithm implements Algorithm, UsesScoreWrapper,
     ...
     */
    public P2(IndependenceWrapper test, ScoreWrapper score) {
        this.test = test;
        this.score = score;
    }
    ...
    public String getDescription() {
        return "P2 using " + this.test.getDescription()
