 ...
 * The values of a and b are given in the constructor, and the sequence of choices is obtained by repeatedly calling the
 ...
 * generated by this class is an array x[] of b integers i, 0 &lt;= i &lt; a, such that x[j] &lt; x[j + 1] for each j
 * from 0 to b - 1.
 * <p>
...
public final class ChoiceGenerator {
    ...
    /**
     * Constructs a new choice generator for a choose b. Once this initialization has been performed, successive calls
     * to next() will produce the series of combinations.  To begin a new series at any time, call this init method
     * again with new values for a and b.
     *
