 ...
 * indices rather than Strings to refer to factors. Since lag graphs are dynamic, they can't do this directly, as the
 * indices might change from one time to the next. However, for certain uses of lag graphs, the graph itself may be
...
public class IndexedConnectivity implements TetradSerializable {
     ...
     *
     * @return a {@link edu.cmu.tetrad.study.gene.tetrad.gene.history.IndexedConnectivity} object
     */
