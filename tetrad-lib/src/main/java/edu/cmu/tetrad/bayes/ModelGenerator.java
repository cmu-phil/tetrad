...
public final class ModelGenerator {
    ...
    public static List<Graph> generate(Graph graph) {
        ...
        for (Edge allEdge : allEdges) {
            ...
            if (!toAdd.getPaths().existsDirectedPathFromTo(n1, n2)) {
        ...
        for (int i = 0; i < allNodes.size(); i++) {
            ...
            for (int j = i + 1; j < allNodes.size(); j++) {
                ...
                if (!graph.isParentOf(node1, node2) &&
                    ...
                    if (!toAdd1.getPaths().existsDirectedPathFromTo(node1, node2)) {  //
                    ...
                    //Make sure adding this edge won't introduce a cycle.
                    if (!toAdd2.getPaths().existsDirectedPathFromTo(node2, node1)) {
