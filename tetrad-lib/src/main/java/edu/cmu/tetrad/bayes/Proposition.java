...
public final class Proposition implements TetradSerializable {
    ...
    public Proposition(Proposition proposition) {
        variableSource = proposition.variableSource;
        allowedCategories =
    ...
    public void restrictToProposition(Proposition proposition) {
        if (proposition.getVariableSource() != variableSource) {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.getMaxNumCategories(); i++) {
            buf.append("\n");
    ...
    private int getMaxNumCategories() {
        ...
        for (int i = 0; i < this.getNumVariables(); i++) {
            if (this.getNumCategories(i) > max) {
