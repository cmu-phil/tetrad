...
public class CorrelationMatrixOnTheFly implements ICovarianceMatrix {
     ...
     */
    public CorrelationMatrixOnTheFly(DataSet dataSet) {
        this(dataSet, false, Runtime.getRuntime().availableProcessors());
    }

    public CorrelationMatrixOnTheFly(DataSet dataSet, int parallelism) {
        this(dataSet, false, parallelism);
    }

    public CorrelationMatrixOnTheFly(DataSet dataSet, boolean verbose) {
        this(dataSet, verbose, Runtime.getRuntime().availableProcessors());
    }

    public CorrelationMatrixOnTheFly(DataSet dataSet, boolean verbose, int parallelism) {
