...
//            if (!(getPredictor(column) instanceof ContinuousVariable)) {
            throw new IllegalArgumentException(
     ...
     * this by calling getPredictor().indexOf(variable).
     */
...
//    }
     ...
     * which they occur in the matrix, is given by getPredictor().
     * <p>
