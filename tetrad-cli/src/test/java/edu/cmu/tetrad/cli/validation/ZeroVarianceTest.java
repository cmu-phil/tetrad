...
public class ZeroVarianceTest {
    ...
    private static final Path dataFile = Paths.get("test", "data", "zero_variance_vars", "sim_data_20vars_100cases.csv");

    public ZeroVarianceTest() {
    }
    ...
    /**
     * Test of validate method, of class ZeroVariance.
     *
     * @throws IOException
     */
    @Test
    public void testValidate() throws IOException {
        System.out.println("validate: ZeroVarianceTest");

        char delimiter = ',';
        ContinuousDataReader dataReader = new TabularContinuousDataReader(dataFile, delimiter);
        DataSet dataSet = dataReader.readInData();

        String dirOut = tmpDir.newFolder("validation_zero-variance").toString();
