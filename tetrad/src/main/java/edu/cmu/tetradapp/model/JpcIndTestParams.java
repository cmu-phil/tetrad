...
public final class JpcIndTestParams implements IndTestParams {
    ...
    private int maxAdjacencies = 10;

    private boolean useCpc = false;
    ...
    public boolean isUseCpc() {
        return useCpc;
    }

    public void setUseCpc(boolean useCpc) {
        this.useCpc = useCpc;
    }
    ...
    public boolean isStartFromEmptyGraph() {
        return startFromEmptyGraph;
    }
