...
//    }
    ...
    public MimBuildTrekRunner(DataWrapper dataWrapper, MimBuildParams params, KnowledgeBoxModel knowledgeBox) {
        super(dataWrapper, params.getClusters(), params);
        this.dataSet = (DataSet) getData();
        setClusters(params.getClusters());
    ...
    public MimBuildTrekRunner(BuildPureClustersRunner pureClustersRunner,
                              MimBuildParams params) {
    ...
    public MimBuildTrekRunner(BuildPureClustersRunner bpcRunner, KnowledgeBoxModel knowledgeBox, MimBuildParams params) {
    ...
    public MimBuildTrekRunner(PurifyRunner runner, MimBuildParams params) {
        super(runner, params);
        this.dataSet = (DataSet) getData();
        setClusters(params.getClusters());
    }

    public MimBuildTrekRunner(PurifyRunner runner, KnowledgeBoxModel knowledgeBox, MimBuildParams params) {
        super(runner, params);
        this.dataSet = (DataSet) getData();
        setClusters(params.getClusters());
        params.setKnowledge(knowledgeBox.getKnowledge());
    ...
    public MimBuildTrekRunner(PurifyRunner runner, DataWrapper dataWrapper, MimBuildParams params) {
        super(runner, params);
        this.dataSet = (DataSet) dataWrapper.getSelectedDataModel();
        setClusters(params.getClusters());
    }

    public MimBuildTrekRunner(PurifyRunner runner, DataWrapper dataWrapper, KnowledgeBoxModel knowledgeBox, MimBuildParams params) {
        super(runner, params);
        this.dataSet = (DataSet) dataWrapper.getSelectedDataModel();
        setClusters(params.getClusters());
        params.setKnowledge(knowledgeBox.getKnowledge());
