 ...
 */
public class FciTRunner extends AbstractAlgorithmRunner
        implements IndTestProducer, GraphSource, IonInput {
    static final long serialVersionUID = 23L;

    //=========================CONSTRUCTORS================================//

    public FciTRunner(DataWrapper dataWrapper, FciSearchParams params) {
     ...
     */
    public FciTRunner(GraphSource graphWrapper, FciSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
        super(graphWrapper.getGraph(), params, knowledgeBoxModel);
    }


    public FciTRunner(DataWrapper dataWrapper, FciSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
        super(dataWrapper, params, knowledgeBoxModel);
    }

    public FciTRunner(Graph graph, FciSearchParams params) {
        super(graph, params);
    }

    public FciTRunner(Graph graph, FciSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
        super(graph, params, knowledgeBoxModel);
    }

    public FciTRunner(GraphWrapper graphWrapper, FciSearchParams params) {
        super(graphWrapper.getGraph(), params);
    }

    public FciTRunner(DagWrapper dagWrapper, FciSearchParams params) {
        super(dagWrapper.getDag(), params);
    }

    public FciTRunner(SemGraphWrapper dagWrapper, FciSearchParams params) {
        super(dagWrapper.getGraph(), params);
    }

    public FciTRunner(IndependenceFactsModel model, FciSearchParams params) {
        super(model, params, null);
    }

    public FciTRunner(IndependenceFactsModel model, FciSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
     ...
     */
    public static FciTRunner serializableInstance() {
        return new FciTRunner(Dag.serializableInstance(),
...
//            setResultGraph(graph);
        ...
        if (indTestParams.isRFCI_Used()) {
            ...
            TFci fci = new TFci(getIndependenceTest());
            fci.setKnowledge(knowledge);
            fci.setCompleteRuleSetUsed(indTestParams.isCompleteRuleSetUsed());
